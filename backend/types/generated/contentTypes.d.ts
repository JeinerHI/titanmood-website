...
export interface ApiTrainingMethodTrainingMethod
  extends Struct.CollectionTypeSchema {
  collectionName: 'training_methods';
  info: {
    displayName: 'Training Method';
    pluralName: 'training-methods';
    singularName: 'training-method';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::training-method.training-method'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo_meta: Schema.Attribute.Component<'shared.seo', false>;
